...
<div class="page-header">
  <h1 style="font-size:40px;"><span class="glyphicon glyphicon-pencil"> UpdateYourProfile</span></h1><hr style="  border-top: 5px solid black;">
...
<form method="post" action="profileupdatecode.php?img=<?php echo $_img; ?>" enctype="multipart/form-data">
 ...
 <div class="form-group">
    ...
    <input id="email" type="text" class="form-control" style="font-weight:bold;color:black;font-size:18px;" name="txtemail" value="<?php echo $_email; ?>" placeholder="Email">
  </div>

<div class="form-group">
     <input id="msg" type="text" class="form-control" style="font-weight:bold;color:black;font-size:18px;" name="txtname" value="<?php echo $_name; ?>" placeholder="Username" >
  </div>
  

  
 <div class="form-group"> 
    <input  type="text" class="form-control" style="font-weight:bold;color:black;font-size:18px;" name="txtmob" value="<?php echo $_mob; ?>" placeholder="Mobile No" >
  </div>
  ...
  <br>
<center><input type="submit"  class="btn btn-primary btn-block" style="color:white;font-size:20px;"name="btnupdate" value="Update Record"></center> 
</form>
</body>
</html>