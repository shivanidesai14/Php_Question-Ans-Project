 ...
 <nav class="navbar navbar-fixed-top navbar-inverse" style="height:80px;">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="contact.php"><h4 style="font-size:25px;"><span class="glyphicon glyphicon-earphone"> Contact </h4></span></a></li>
...
padding: 15px;">
  ...
  <div class="container">  
	<div class="col-md-8">
<div>
  <h1 style="font-size:40px;"><span class="glyphicon glyphicon-phone-alt"> ContactUs </span></h1>  <hr style="  border-top: 5px solid black;">
</div>
<!-- Header End====================================================================== -->
<?php
 $_email=$_SESSION["mail"];
?>
    ...
    <input type="text" style="font-weight:bold;color:black;font-size:18px;" class="form-control" name="txtname" placeholder="Enter Name">
  </div>
		   <div class="form-group">
           
              <input type="text" name="txtemail" placeholder="email" style="font-weight:bold;color:black;font-size:18px;" value="<?php echo $_email; ?>"  class="form-control"/>
           
          </div>
		    <div class="form-group">
   
    <input type="text" class="form-control" name="txtsubject" style="font-weight:bold;color:black;font-size:18px;" placeholder="Enter Subject">
  </div>
           <div class="form-group"> 
  <textarea class="form-control" name="txtreview" rows="5" style="font-weight:bold;color:black;font-size:18px;" placeholder="Your View.." id="comment"></textarea>
</div>

            <input class="btn btn-block btn-primary" style="color:white;font-size:20px;" type="submit" name="btnsubmit" value="Send Messages"></button>
