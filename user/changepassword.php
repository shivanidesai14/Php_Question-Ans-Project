...
<div class="page-header">
  <h1><span class="glyphicon glyphicon-lock"> ChangePassword</span></h1><hr style="  border-top: 5px solid black;">

<form method="post" action="passcode.php">
 <div class="form-group">

<input type="password" style="font-weight:bold;color:black;" class="form-control" name="txtold" placeholder="Enter Old Password">
</div>

<div class="form-group">
<input type="password" style="font-weight:bold;color:black;" class="form-control" placeholder="Enter New Password" name="txtnew" >
</div>

<div class="form-group">
<input type="password" style="font-weight:bold;color:black;" class="form-control" placeholder="Enter Confirm Password" name="txtcnew">
</div>

<input type="submit" class="btn btn-primary btn-block" style="color:white;font-size:20px;" name="btnchange" value="Change Password">
</form>
</body>
</html>