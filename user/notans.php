...
<div class>
  ...
  <li role="presentation" class="active" style="font-size:25px;" ><a href="notans.php" >Not Answered</a></li>
...
echo '<h4><img src="'. $_img .'" class="img-circle" width="70" height="70"></img>&nbsp&nbsp<b style="text-align:top;">'. $_name .'</b><p  style="float:right;"><span class="glyphicon glyphicon-time  aria-hidden="true">'. $date .'</span></p></h4><br>';    
    echo '<div class="panel panel-heading" style="background-color:rgb(215,233,213); font-weight:bold;"><a href="questiondetail.php?id='.$row["question_id"].'">' .  $row["question_desc"] . '</a></div>';
    echo '<h3><a href="ans.php?id='.$row["question_id"].'"><button type="button" class="btn btn-primary btn-sm">Answers</button></a> <a href="questiondetail.php?id='.$row["question_id"].'">  <button type="button" class="btn btn-default btn-sm">Discuss <span class="badge">'. $cnt .'</span></button></a> <span class="glyphicon glyphicon-thumbs-up btn btn-primary btn-sm"> Like</span></a></h3>';
echo '</div>';
  echo  '</div>';
  $i=$i+1;
}*/
